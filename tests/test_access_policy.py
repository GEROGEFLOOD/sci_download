...
from scidl.access_policy import (
    AccessDecision,
    UnsupportedSourceError,
    evaluate_response,
    reject_unsupported_url,
)
...
def test_restriction_statuses():
    ...
    decision = evaluate_response(response(text="please complete the CAPTCHA"))
    assert decision is AccessDecision.CAPTCHA_REQUIRED
